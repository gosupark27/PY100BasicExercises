...
# The str.format method is a popular method, but since Python 3.6, a new way called f-strings (formatted string literals) was introduced.
...
format_string = str.format("Hello, {}. You are a {}", name, profession)
# How can you achieve the same result using an f-string?
f_string = f"Hello, {name}. You are a {profession}."
